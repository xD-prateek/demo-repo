...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='probot_gazebo').find('probot_gazebo')
    default_model_path = os.path.join(pkg_share, 'src/description/probot_description.urdf')
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=['-entity', 'probot', '-topic', 'robot_description'],
        output='screen'
    )
